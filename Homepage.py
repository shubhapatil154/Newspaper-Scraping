...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        labelfont = ('times', 20, 'bold')
        widget = Label(root, text="Deccan Herald",fg="green")
        widget.config(font=labelfont) 
        widget.place(x=80,y=300) 
        labelfont = ('times', 15, 'bold')
        widget = Button(root,text="read")
        widget.config(font=labelfont)
        widget.place(x=80,y=350)

        labelfont = ('times', 20, 'bold')
        widget = Label(root, text="Deccan Chronical",fg="green")
        widget.config(font=labelfont) 
        widget.place(x=80,y=400) 
        labelfont = ('times', 15, 'bold')
        widget = Button(root,text="read")
        widget.config(font=labelfont)
        widget.place(x=80,y=450)

        labelfont = ('times', 20, 'bold')
        widget = Label(root, text="Times Of India",fg="green")
        widget.config(font=labelfont) 
        widget.place(x=80,y=500) 
        labelfont = ('times', 15, 'bold')
        widget = Button(root,text="read")
        widget.config(font=labelfont)
        widget.place(x=80,y=550)
